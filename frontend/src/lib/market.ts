...
export const VAULT_WATCH_TOKENS: VaultWatchToken[] = [
  ...
  // Expansion below: every 01 Exchange/N1 (terminal.trade)-listed token not
  // already above that has BOTH a live Binance USDT pair (for this relay's
  // direct feed) AND a stable, active Pyth feed (cross-checked against
  // hermes_id/state, not just a name match). CoinGecko ids below were each
  // disambiguated empirically — verified against N1's own live indexPrice
  // (GET /markets/live on zo-mainnet.n1.xyz) so an ambiguous ticker (e.g.
  // multiple unrelated coins both called "S" or "LIT") couldn't silently
  // pick the wrong coin.
  ...
  { sym: 'XPL', name: 'Plasma', pythFeedId: '9873512f5cb33c77ad7a5af098d74812c62111166be395fd0941c8cedb9b00d4', coingeckoId: 'plasma' },
  { sym: 'S', name: 'Sonic', pythFeedId: 'f490b178d0c85683b7a0f2388b40af2e6f7c90cbe0f96b31f315f08d0e5a2d6d', coingeckoId: 'sonic-3' },
  { sym: 'JUP', name: 'Jupiter', pythFeedId: '0a0408d619e9380abad35060f9192039ed5042fa6f82301d0e48bb52be830996', coingeckoId: 'jupiter-exchange-solana' },
  { sym: 'ARB', name: 'Arbitrum', pythFeedId: '3fa4252848f9f0a1480be62745a4629d9eb1322aebab8a791e344b3b9c1adcf5', coingeckoId: 'arbitrum' },
  { sym: 'LIT', name: 'Lighter', pythFeedId: 'c0c83f00c39165892d55dcd17ade2191e289697e2ac132d9ab721e20834e2a9e', coingeckoId: 'lighter' },
  { sym: 'PUMP', name: 'Pump.fun', pythFeedId: '7a01fca212788bba7c5bf8c9efd576a8a722f070d2c17596ff7bb609b8d5c3b9', coingeckoId: 'pump-fun' },
  { sym: 'UNI', name: 'Uniswap', pythFeedId: '78d185a741d07edb3412b09008b7c5cfb9bbbd7d568bf00ba737b456ba171501', coingeckoId: 'uniswap' },
  { sym: 'MON', name: 'Monad', pythFeedId: '31491744e2dbf6df7fcf4ac0820d18a609b49076d45066d3568424e62f686cd1', coingeckoId: 'monad' },
  { sym: 'VVV', name: 'Venice Token', pythFeedId: '5ece7483ae221e3645ec0f9b5c6671ac830cb85471744df5d8e7deae152e31a2', coingeckoId: 'venice-token' },
  { sym: 'MORPHO', name: 'Morpho', pythFeedId: '5b2a4c542d4a74dd11784079ef337c0403685e3114ba0d9909b5c7a7e06fdc42', coingeckoId: 'morpho' },
];
