          ...
          return (
            <button
              ...
              className={`flex items-center gap-3 px-3 py-3 rounded-lg transition-all duration-300 w-full font-bold text-[13px] ${
                isActive
                  ? 'bg-[#00A8E8]/10 text-[#00A8E8] border border-[#00A8E8]/50 shadow-[inset_0_0_20px_rgba(0,168,232,0.35)] dark:bg-[#00A8E8]/15 dark:text-[#00A8E8] dark:border-[#00A8E8]/50 dark:shadow-[inset_0_0_20px_rgba(0,168,232,0.35)]'
