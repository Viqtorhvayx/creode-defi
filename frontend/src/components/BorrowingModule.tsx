...
export const BorrowingModule: React.FC<BorrowingModuleProps> = ({ xp: initialXP, theme }) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full">
      ...
      {/* RIGHT COLUMN: Reputation Metric & Heartbeat */}
      <div className="lg:col-span-5 bg-black/[0.03] dark:bg-white/[0.04] border border-black/5 dark:border-white/5 !rounded-[48px] p-12 shadow-[0_30px_100px_rgba(0,0,0,0.4)] interactive-pop min-h-[500px] flex flex-col">
        <div className="mb-8">
        ...
        <div className="flex-1 flex flex-col justify-center gap-12">
          ...
          <div className="h-32 w-full bg-[#0a0a0a] rounded-[32px] border border-white/5 relative overflow-hidden flex items-center justify-center group shadow-inner">
            ...
            <div className="relative z-10 flex items-center gap-6 bg-black/60 px-8 py-3 rounded-full backdrop-blur-md border border-white/5 shadow-2xl">
               <div className="flex flex-col items-center">
                 <span className="text-[10px] font-bold opacity-50 uppercase tracking-widest text-white">Stability</span>
               ...
               <div className="flex flex-col items-center">
                 <span className="text-[10px] font-bold opacity-50 uppercase tracking-widest text-white">Pulse</span>
               ...
               <div className="w-[1px] h-8 bg-white/10" />
               <div className="flex flex-col items-center">
                 <span className="text-[10px] font-bold opacity-50 uppercase tracking-widest text-white">Risk</span>
          ...
          <div className="text-center flex flex-col gap-2">
            <p className="text-5xl font-black flex items-baseline justify-center gap-2">
              <span style={{ color: getXPColor(currentXP), textShadow: `0 0 30px ${getXPColor(currentXP)}80` }}>{currentXP}</span>
              <span className="text-xl font-bold opacity-30">/ 100</span>
            </p>
            <p className="text-[12px] font-bold opacity-40 uppercase tracking-widest" style={{ color: primaryTextColor }}>Global Reputation Score</p>
          </div>
        </div>
      </div>
    </div>
