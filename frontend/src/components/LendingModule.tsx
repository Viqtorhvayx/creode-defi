  ...
  return (
    <div className="industrial-panel bg-surface">
      <div className="flex justify-between items-start mb-8">
        <div>
          <h3 className="text-[11px] font-bold uppercase tracking-wider text-black/30 dark:text-white/40">Liquidity Pool</h3>
          <p className="text-xl font-black text-black dark:text-white">Deploy Liquidity</p>
        </div>
        <div className="text-right">
          <p className="text-[10px] font-bold text-black/30 dark:text-white/40 uppercase">Earned Points</p>
      ...
      <div className="space-y-6">
        <div>
          <label className="text-[10px] font-bold text-black/40 dark:text-white/60 uppercase block mb-2">Amount to Provide (HBAR)</label>
          <input 
            type="number" 
            placeholder="0.00"
