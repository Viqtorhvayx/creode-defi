...
export const PriceChart: React.FC<PriceChartProps> = ({ theme }) => {
  ...
  return (
    <div className="industrial-panel w-full mx-auto !p-6 flex flex-col h-full relative overflow-visible">
      {isInfoActive && (
        <div className="absolute top-14 right-6 w-56 bg-white/10 dark:bg-black/40 backdrop-blur-2xl border border-white/20 rounded-xl p-4 shadow-2xl z-[110] animate-in fade-in zoom-in duration-200">
