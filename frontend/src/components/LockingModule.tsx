...
export const LockingModule: React.FC<LockingModuleProps> = ({ theme }) => {
  ...
  const getButtonClasses = (action: 'deposit' | 'withdraw' | 'set') => {
    ...
    const baseClasses = "flex-1 min-w-[120px] !py-2.5 !h-auto font-bold transition-all duration-300 rounded-2xl hover:-translate-y-1 hover:shadow-md active:scale-95";
    return isActive 
