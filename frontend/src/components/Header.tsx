    ...
    <header className="w-full pt-4 pb-4 mb-10 sticky top-0 z-50 bg-transparent transition-all duration-500 border-none outline-none">
      ...
      <nav className="max-w-7xl mx-auto px-6 flex justify-between items-center w-full">
        ...
        <div className="flex-1 flex justify-center">
          <div className="flex items-center gap-8 px-8 py-3 bg-white/5 dark:bg-black/20 backdrop-blur-md rounded-[28px] border-none outline-none ring-0 focus:outline-none shadow-[0_8px_30px_-5px_rgba(0,168,232,0.6)]">
            {tabs.map((tab) => (
              <button
                key={tab}
