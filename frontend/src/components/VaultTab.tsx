  ...
  return (
    <div className="w-full mx-auto flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full mb-8 items-start">
        ...
        <div className="lg:col-span-5 bg-white dark:bg-[#0F141A] border border-[#00A8E8]/80 rounded-[16px] p-8 shadow-[inset_0_0_20px_rgba(0,168,232,0.35),0_0_20px_rgba(0,168,232,0.4)] flex flex-col relative overflow-hidden h-fit">
