                ...
                <div className="relative mb-[14px]" ref={dropdownRef}>
                  ...
                  >
                    {activeToken === 'HBAR' && !isLogosLoading && hbarLogoUrlSmall ? (
                      ...
                      <img src={jamLogoUrlSmall} alt="JAM Logo" className="w-5 h-5 rounded-full object-cover shrink-0 shadow-sm dark:shadow-none bg-slate-900 dark:bg-white" />
                    ) : (
                    ...
                    <div className="flex flex-col max-h-[280px] overflow-y-auto p-1.5 [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-thumb]:bg-slate-200 dark:[&::-webkit-scrollbar-thumb]:bg-white/10 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full">
                      {TOKENS.map(token => (
                        <div 
                          ...
                          className={`flex items-center justify-between p-2.5 rounded-xl cursor-pointer transition-all duration-200 group ${activeToken === token ? 'bg-[#00A8E8]/10 dark:bg-[#00A8E8]/20 ring-1 ring-[#00A8E8]/50 shadow-[0_0_10px_rgba(0,168,232,0.15)]' : 'hover:bg-[#00A8E8]/5 dark:hover:bg-[#00A8E8]/10'}`}
                        >
