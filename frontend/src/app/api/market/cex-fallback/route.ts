 ...
 * once the primary Pyth Hermes stream has gone quiet for 10+ seconds
 * (Binance-primary, Bybit-backup cascade — the same underlying source 01
 * Exchange/N1's own listed tokens trade against). Server-side because neither exchange's
